...
class VirusAntibodyModel(Model):
    ...
    def __init__(
        ...
        Args:
            ...
            initial_antibody: Number of Ants in the simulation (default: 30)
            initial_viruses: Number of viruses in the simulation (default: 10)
        ...
        Indirect Args (not chosen in the graphic interface for clarity reasons):
            antibody_sight_range: Radius within which ants can detect food
    ...
    def step(self):
        ...
        if len(self.agents_by_type[AntibodyAgent]) > 200 or len(self.agents_by_type[VirusAgent]) > 200:
