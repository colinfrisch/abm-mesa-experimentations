...
> **Introduction**
> [Overview](#overview) - Context & General architecture
>
> **API Design**
> [Memory in Mesa-LLM agents](#memory-in-mesa-llm-agents) - Memory structures & Challenges
> [Making the LLM agent act](#making-the-llm-agent-act) - Reasoning & Tool calling
> [Optimizing the extension](#optimizing-the-extension) - Parallelization & Recording
> [Finalization](#finalization-examples-tests-and-docs) - Examples, Tests & Docs
>
> **Conclusion**
> [Learnings](#learnings) - What I learned
> [Future work](#future-work) - What I plan to do
> [Links](#links) - Meetings, PRs, etc.
